...
Tag info{:.info} Tag_succès{:.success} warning{:.warning} error{:.error}

## Ceci est un dexième sous titre

Ceci est une bulle info.{:.info}

Ceci est une bulle succès.{:.success}

Ceci est une bulle avertissement. {:.warning}

Ceci est une bulle erreur. {:.error}
